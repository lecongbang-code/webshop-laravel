        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a href="{{ url('/add-product') }}" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Thêm sản phẩm mới</a>
                </div>
                <div class="card-body">
                    <table class="table table-striped" id="table1" style="text-align: center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if($product->status_adv=='on'){
                                            ?>
                                            <a href="{{URL::to('/unactive-product-adv/'.$product->id)}}"><span class="btn btn-primary"><i class="bi bi-badge-ad"></i></span></a>
                                            <?php
                                            }else{
                                            ?>  
                                            <a href="{{URL::to('/active-product-adv/'.$product->id)}}"><span class="btn btn-dark"><i class="bi bi-badge-ad"></i></span></a>
                                            <?php
                                        }
                                    ?>
                                </td>
                                <td>
                                    <?php
                                        if($product->status=='on'){
                                            ?>
                                            <a href="{{URL::to('/unactive-product/'.$product->id)}}"><span class="btn btn-success"><i class="bi bi-eye"></i></span></a>
                                            <?php
                                            }else{
                                            ?>  
                                            <a href="{{URL::to('/active-product/'.$product->id)}}"><span class="btn btn-dark"><i class="bi bi-eye"></i></span></a>
                                            <?php
                                        }
                                    ?>
                                </td>
                                ...
                                <td>
                                    <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này ko?')" href="{{URL::to('/delete-product/'.$product->id)}}"><span class="btn btn-danger"><i class="bi bi-trash"></i></span></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
